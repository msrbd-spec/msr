...
Usage:
    python decode_pngs.py
    python decode_pngs.py --input archive.json --output ./restored
"""
...
def main():
    ...
    parser.add_argument(
        "--output", "-o",
        default="./restored_pngs",
        help="Output directory for restored PNG files (default: ./restored_pngs).",
    )
